...
npm install uvicorn
pip install --no-cache-dir lime scikit-learn pandas numpy matplotlib geopandas fastapi dotenv torch seaborn pygbif rasterio shap groq uvicorn
...
```bash
python -m uvicorn api:app -env-file .env --port 8000     
```
